                ...
                <table class="min-w-full table-auto border border-gray-200">
                    <thead class="bg-gray-100">
                        <tr>
                            ...
                            <th class="px-4 py-2 text-left text-sm font-medium text-gray-600">Nama Dokter</th>
                            <th class="px-4 py-2 text-left text-sm font-medium text-gray-600">Hari</th>
                            <th class="px-4 py-2 text-left text-sm font-medium text-gray-600">Start</th>
                            <th class="px-4 py-2 text-left text-sm font-medium text-gray-600">End</th>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="px-4 py-2 text-sm text-gray-800">{{ schedule.doctor.name }}</td>
                            <td class="px-4 py-2 text-sm text-gray-800">{{ schedule.day }}</td>
  ...
  <td class="px-4 py-2 text-sm text-gray-800">
    {{ formatTime(schedule.end_time) }}
                            ...
                            <td class="px-4 py-2 text-sm flex">
                                <Link :href="route('schedules.edit', schedule.id)" class="text-blue-600 mr-2">Edit</Link>
                                <button type="button" @click="deleteSchedule(schedule.id)" class="text-red-600">Hapus</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
